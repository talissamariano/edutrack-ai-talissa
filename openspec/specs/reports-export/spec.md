...
Define a página de Relatórios do EduTrack AI: como o usuário autenticado exporta seus dados acadêmicos (tarefas, disciplinas e snapshot do dashboard) em CSV e PDF, com escopo restrito aos próprios dados, geração 100% client-side e sem dependência de novos endpoints Xano.
